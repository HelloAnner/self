...
> 状态：Phase 9 已实现 Document/Revision/Chunk/FTS/Vector 核心与 Note 安全修改、移动、删除、恢复和 Undo（Schema 10）
...
- Knowledge 发布后只通知 Graph；Graph 自己维护 Node/Relation/Claim 表，Knowledge 不跨领域写图表。
