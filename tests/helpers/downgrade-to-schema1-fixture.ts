...
if (!root) throw new Error("Usage: downgrade-to-schema1-fixture.ts <root>");
...
try {
  database.exec(`
    ...
    DROP TABLE source_batch_receipts;
    DROP TABLE source_snapshot_changes;
    DROP TABLE source_snapshot_entries;
    DROP TABLE source_snapshots;
    DROP TABLE source_blobs;
    DROP TABLE sources;
    DELETE FROM schema_migrations WHERE version >= 2;
    UPDATE workspace SET database_schema_version = 1, version = version + 1;
